...
describe('admin permission vocabulary', () => {
  ...
  it('gives viewer the general read permissions, excluding the restricted ones', () => {
    ...
    // and Operations/Usage are admin/superadmin only; shop.read joins them
    // (Phase 1: commerce catalog/pricing data is admin/superadmin only, not a
    // generic-viewer read, same posture as the other two).
