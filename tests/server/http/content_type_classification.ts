...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/shop/categories': PROBLEM_JSON,
  '/api/shop/categories/:slug': PROBLEM_JSON,
  '/api/shop/products': PROBLEM_JSON,
  '/api/shop/products/:slug': PROBLEM_JSON,
  '/api/shop/orders': PROBLEM_JSON,
  '/api/shop/orders/:id': PROBLEM_JSON,
  '/api/shop/buy': PROBLEM_JSON,
  '/api/shop/claudium/balance': PROBLEM_JSON,
  '/api/shop/claudium/history': PROBLEM_JSON,
  '/api/shop/packages': PROBLEM_JSON,
  '/api/shop/packages/:id/checkout': PROBLEM_JSON,
  '/api/shop/claudium/stripe/webhook': PROBLEM_JSON,
  '/api/shop/packages/purchases/:sessionId': PROBLEM_JSON,
  '/api/card': BINARY,
