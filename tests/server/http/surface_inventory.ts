...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  // In-game Shop storefront (server/shop_storefront_catalog_routes.ts,
  // shop_storefront_orders_routes.ts, shop_buy_routes.ts): registry-only
  // RouteDefs, same new-route rule as the deeds/Steam families above: no
  // legacy ladder arm. The catalog routes are rate-limited the same way the
  // deeds rarity read and the character-sheet/search routes are
  // (publicReadRateLimited, in-handler); the order routes are
  // requireAccount-gated (never anonymous) and always scope to the caller's
  // own accountId.
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    ...
    handler:
      'server/shop_storefront_catalog_routes.ts listCategoriesHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'publicReadRateLimited',
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_storefront_catalog_routes.ts getCategoryHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'publicReadRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.publicRead,
    match: /^\/api\/shop\/categories\/([^/]+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    ...
    handler:
      'server/shop_storefront_catalog_routes.ts listProductsHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'publicReadRateLimited',
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_storefront_catalog_routes.ts getProductHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: 'publicReadRateLimited',
    requireOwnedExpected: REQUIRE_OWNED.publicRead,
    match: /^\/api\/shop\/products\/([^/]+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
    path: '/api/shop/orders',
    handler: 'server/shop_storefront_orders_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'GET',
    path: '/api/shop/orders',
    handler: 'server/shop_storefront_orders_routes.ts listHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.bearer,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_storefront_orders_routes.ts getHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.bearer,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.bola404,
    match: /^\/api\/shop\/orders\/(\d+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
  ...
  // Claudium ledger (server/claudium_ledger_routes.ts): the in-repo
  // balance/history reads over server/claudium_ledger.ts. Lives under
  // /api/shop/claudium/* rather than /api/claudium/* (server/claudium.ts's
  // own prefix, the pass-through to the external economy service) so the two
  // systems never collide on a path.
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
  ...
  // Claudium Packages (server/claudium_packages.ts): the public storefront
  // read over the admin-managed catalog of purchase tiers.
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
  ...
  // Claudium Package purchases (server/claudium_purchases_routes.ts): starts
  // a real-money Stripe Checkout Session for a package. :id is the PACKAGE
  // id (a catalog item), not an account-owned resource, so this row carries
  // no requireOwned loader.
  {
    dispatcher: DISPATCH.mainApi,
    method: 'POST',
  ...
  // prefix owner than the legacy /api/claudium/stripe/webhook
  ...
  // Claudium Package purchase status poll (server/claudium_purchases_routes.ts):
  // the caller's own purchase, keyed on the opaque Stripe session id (not a
  // bigserial, so the ownership check is inlined in the handler rather than
  // the numeric-only requireOwned loader).
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
  ...
  // Shop catalog (categories/products/inventory): registry-only RouteDefs born
  // AFTER the migration, per the new-route rule (server/http/CLAUDE.md), same
  // as the deeds/Steam families above: they have NO legacy handleAdminApi arm.
  // requireAdmin only accepts GET/POST, so update is POST to the plain :id
  // path and delete is a literal POST .../:id/delete suffix rather than the
  // PUT/DELETE methods.
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/shop/categories',
    handler: 'server/shop_categories_routes.ts listHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'POST',
    path: '/admin/api/shop/categories',
    handler: 'server/shop_categories_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_categories_routes.ts getHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/categories\/(\d+)$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/categories/:id',
    handler: 'server/shop_categories_routes.ts updateHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
  ...
  },
  {
    ...
    handler: 'server/shop_categories_routes.ts deleteHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/categories\/(\d+)\/delete$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/shop/products',
    handler: 'server/shop_products_routes.ts listHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'POST',
    path: '/admin/api/shop/products',
    handler: 'server/shop_products_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_products_routes.ts getHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/products\/(\d+)$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/products/:id',
    handler: 'server/shop_products_routes.ts updateHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
  ...
  },
  {
    ...
    handler: 'server/shop_products_routes.ts deleteHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/products\/(\d+)\/delete$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/shop/inventory',
    handler: 'server/shop_inventory_routes.ts listHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'POST',
    path: '/admin/api/shop/inventory',
    handler: 'server/shop_inventory_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_inventory_routes.ts getHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/inventory\/(\d+)$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/inventory/:id',
    handler: 'server/shop_inventory_routes.ts updateHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
  ...
  },
  {
    ...
    handler: 'server/shop_inventory_routes.ts deleteHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/inventory\/(\d+)\/delete$/,
  },
  // Shop orders: admin-only back-office order entry + fulfillment over the
  // catalog above. Same registry-only shape as categories/products/inventory:
  // no legacy handleAdminApi arm, POST-only writes (status/cancel/refund are
  // literal action suffixes, not PUT/DELETE).
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/shop/orders',
    handler: 'server/shop_orders_routes.ts listHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    method: 'POST',
    path: '/admin/api/shop/orders',
    handler: 'server/shop_orders_routes.ts createHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'server/shop_orders_routes.ts getHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/orders\/(\d+)$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/orders/:id/status',
    handler: 'server/shop_orders_routes.ts updateStatusHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/orders\/(\d+)\/status$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/orders/:id/cancel',
    handler: 'server/shop_orders_routes.ts cancelHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
    match: /^\/admin\/api\/shop\/orders\/(\d+)\/cancel$/,
  },
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
    path: '/admin/api/shop/orders/:id/refund',
    handler: 'server/shop_orders_routes.ts refundHandler (registry-only RouteDef)',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: REQUIRE_OWNED.operator404,
  ...
  // Claudium ledger admin adjust: grant/deduct an account's Claudium
  // (ADMIN_ADD/ADMIN_REMOVE), server/claudium_ledger_routes.ts.
  {
    dispatcher: DISPATCH.admin,
    method: 'POST',
  ...
  // Claudium Packages: admin CRUD over the purchase-tier catalog,
  ...
  // Claudium Package purchases payment history / audit log
