...
export class Hud {
  ...
  // In-game Shop hooks (Phase 5): null offline/pre-attach, exactly like
  // claudiumHooks above; attachShop() is called alongside attachClaudium().
  ...
  /** Inject the in-game Shop hooks behind the Store tab (main.ts, online only). */
