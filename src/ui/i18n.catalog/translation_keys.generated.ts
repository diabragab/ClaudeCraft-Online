...
export type TranslationKeyFlat =
  ...
  | 'hudChrome.wocStore.purchaseResult.dismiss'
  ...
  | 'store.badge.bestValue'
  | 'store.badge.event'
  | 'store.badge.exclusive'
  ...
  | 'store.home.carouselLabel'
  | 'store.home.carouselNext'
  | 'store.home.carouselPrev'
  ...
  | 'store.rarity.common'
  | 'store.rarity.epic'
  | 'store.rarity.legendary'
  | 'store.rarity.mythic'
  | 'store.rarity.rare'
  | 'store.rarity.uncommon'
  | 'wallet.appConnected'
  | 'wallet.bagConnect'
  | 'wallet.bagLink'
  | 'wallet.bagReconnect'
