...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.generalBody': '這裡的所有商品均以克勞迪幣計價，購買後立即發放。',
  'hudChrome.wocStore.searchPlaceholder': '搜尋商店',
  'hudChrome.wocStore.categoryFilterLabel': '依分類篩選',
  'hudChrome.wocStore.categoryFilterAll': '所有分類',
  'hudChrome.wocStore.uncategorized': '未分類',
  'hudChrome.wocStore.noResults': '沒有符合搜尋條件的商品。',
  'hudChrome.wocStore.packagesBody': '可使用真實貨幣購買的克勞迪幣禮包。',
  ...
  'hudChrome.wocStore.purchaseResult.successTitle': '購買成功！',
  'hudChrome.wocStore.purchaseResult.successBody': '{item} 已加入您的帳戶。',
  'hudChrome.wocStore.purchaseResult.failureTitle': '購買失敗',
  'hudChrome.wocStore.purchaseResult.failureBody': '完成 {item} 的購買時發生問題，請再試一次。',
  'hudChrome.wocStore.purchaseResult.dismiss': '關閉',
  ...
  'guide.glossary.loadoutDef':
    '一套已儲存的天賦分配。保留數套，即可在不同構築之間切換，無需一點一點重新投入天賦點。',
  ...
  'guide.gear.setsBody':
    '有些護甲以成套的家族出現，數件裝備經過剪裁，使其外觀與戰鬥表現渾然一體。同時穿上足夠多的同家族裝備，套裝便會甦醒，在每件裝備本身的屬性之上額外賦予加成，而你穿得愈多，效果就愈強。少數這樣的家族會在你升級途中作為珍貴的掉落現身；其中最頂尖的則來自接近等級上限的最艱難團隊內容，因此追求一整套裝是經典的終局目標。',
  ...
  'hudChrome.deeds.retroSummary': '你的編年史已更新：補錄 {count} 項功績。',
  ...
  'guide.gear.bagsBody':
    '你拾取的一切都收在同一個共用背包裡，而你可以透過裝備袋子來擴充它。你的背包視窗設有四個袋子欄位：點擊背包中的袋子，即可將它掛入空閒的欄位，而你所裝備的每個袋子都會增添各自的空間。簡易的袋子是廉價的商人貨品，較寬敞的則從野獸身上掉落，最上乘的則出自地城首領，因此你的攜物空間會隨著裝備一同成長。',
  ...
  'guide.settingsPage.factSearchBody':
    '不確定某個選項在哪裡？在選單頂端的搜尋框中輸入即可。它也聽得懂常見的說法，因此輸入 fps 就能找到 FPS 讀數，而選擇一項結果會直接跳到該設定並將其標亮。',
  'guide.settingsPage.factSearchTitle': '搜尋最快找到',
  ...
  'hudChrome.enchanting.disenchantThrottled': '你分解得太快了。請稍候再試。',
  'hudChrome.enchanting.salvageThrottled': '你拆解得太快了。請稍候再試。',
  'hudChrome.enchanting.enchantThrottled': '你附魔得太快了。請稍候再試。',
  ...
  'store.availability.inStock': '有貨',
  'store.availability.lowStock': '庫存不多',
  'store.availability.outOfStock': '缺貨',
  'store.availability.unavailable': '無法購買',
  'store.availability.unlimited': '有貨',
  'store.cart.checkout': '前往結帳',
  'store.cart.colPrice': '價格',
  'store.cart.colProduct': '商品',
  'store.cart.colQuantity': '數量',
  'store.cart.colSubtotal': '小計',
  'store.cart.empty': '您的購物車是空的。',
  'store.cart.subtotalLabel': '小計',
  'store.cart.title': '我的購物車',
  'store.categories.empty': '目前尚無分類。',
  'store.categories.title': '分類',
  'store.checkout.emptyCart': '購物車是空的，請先加入商品再結帳。',
  'store.checkout.noteLabel': '訂單備註（選填）',
  'store.checkout.notePlaceholder': '有什麼需要讓團隊知道的事項嗎',
  'store.checkout.orderFailed': '下單失敗。',
  'store.checkout.outOfStockError': '購物車中有商品庫存不足。',
  'store.checkout.placeOrder': '送出訂單',
  'store.checkout.placingOrder': '正在送出訂單……',
  'store.checkout.reviewTitle': '訂單確認',
  'store.checkout.signInLink': '前往登入',
  'store.checkout.signInRequiredBody': '請先到首頁登入後再下單。',
  'store.checkout.signInRequiredTitle': '需要登入',
  'store.checkout.title': '結帳',
  'store.checkout.totalLabel': '總計',
  'store.common.addToCart': '加入購物車',
  'store.common.continueShopping': '繼續購物',
  'store.common.error': '發生錯誤，請重試。',
  'store.common.loading': '載入中……',
  'store.common.quantityLabel': '數量',
  'store.common.remove': '移除',
  'store.common.retry': '重試',
  'store.common.viewDetails': '查看詳情',
  'store.confirmation.body': '您的訂單 #{id} 已送出，正在等待處理。',
  'store.confirmation.title': '訂單已送出',
  'store.confirmation.viewOrder': '查看訂單',
  'store.home.browseAll': '瀏覽全部商品',
  'store.home.carouselLabel': '精選商品輪播',
  'store.home.carouselPrev': '上一個精選商品',
  'store.home.carouselNext': '下一個精選商品',
  'store.home.categoriesTitle': '依分類選購',
  'store.home.featuredTitle': '精選商品',
  'store.home.heroSubtitle': '瀏覽分類、精選商品與新品上架。',
  'store.home.heroTitle': '歡迎光臨商店',
  'store.home.newTitle': '新品上架',
  'store.home.noFeatured': '目前尚無精選商品。',
  'store.home.noNew': '目前尚無新品。',
  'store.nav.categories': '分類',
  'store.nav.orders': '我的訂單',
  'store.nav.packages': '克勞迪幣禮包',
  'store.nav.products': '商品',
  'store.nav.signedInAs': '已登入：{name}',
  'store.notFound.backHome': '返回商店首頁',
  'store.packages.title': '克勞迪幣禮包',
  'store.packages.subtitle': '使用信用卡或簽帳金融卡購買克勞迪幣，由 Stripe 安全處理。',
  'store.packages.empty': '目前沒有可購買的克勞迪幣禮包。',
  'store.packages.claudiumAmount': '{amount} 克勞迪幣',
  'store.packages.bonusLabel': '額外贈送 {amount} 克勞迪幣',
  'store.packages.featuredBadge': '精選',
  'store.packages.discountBadge': '折扣 {percent}%',
  'store.packages.buy': '立即購買',
  'store.packages.starting': '正在開始結帳...',
  'store.packages.checkoutFailed': '無法開始結帳，請重試。',
  'store.packages.signInRequiredBody': '請在 World of ClaudeCraft 首頁登入以購買克勞迪幣。',
  'store.packageConfirmation.paidTitle': '感謝您的購買',
  'store.packageConfirmation.paidBody': '來自{package}的 {amount} 克勞迪幣已加入您的帳戶。',
  'store.packageConfirmation.pendingTitle': '正在確認您的付款',
  'store.packageConfirmation.pendingBody': '這只需要片刻，請保持此頁面開啟。',
  'store.packageConfirmation.failedTitle': '付款未完成',
  'store.packageConfirmation.failedBody': '此次購買未完成，因此未扣款也未發放克勞迪幣。',
  'store.packageConfirmation.missingSession': '此確認連結缺少結帳工作階段資訊。',
  'store.rarity.common': '普通',
  'store.rarity.uncommon': '優秀',
  'store.rarity.rare': '精良',
  'store.rarity.epic': '史詩',
  'store.rarity.legendary': '傳說',
  'store.rarity.mythic': '神話',
  'store.badge.new': '新品',
  'store.badge.hot': '熱門',
  'store.badge.featured': '精選',
  'store.badge.bestValue': '超值',
  'store.badge.limited': '限量',
  'store.badge.sale': '特惠',
  'store.badge.event': '活動',
  'store.badge.exclusive': '限定',
  'store.badge.popular': '人氣',
  'store.notFound.body': '該商店頁面不存在。',
  'store.notFound.title': '找不到頁面',
  'store.orderDetail.colLineTotal': '小計',
  'store.orderDetail.colProduct': '商品',
  'store.orderDetail.colQuantity': '數量',
  'store.orderDetail.colUnitPrice': '單價',
  'store.orderDetail.itemsTitle': '商品明細',
  'store.orderDetail.notFound': '找不到該訂單。',
  'store.orderDetail.placedLabel': '下單時間',
  'store.orderDetail.statusLabel': '狀態',
  'store.orderDetail.summaryTitle': '訂單概要',
  'store.orderDetail.timelineCreated': '訂單已建立，狀態為{status}',
  'store.orderDetail.timelineTitle': '狀態歷程',
  'store.orderDetail.title': '訂單 #{id}',
  'store.orderDetail.updatedLabel': '更新時間',
  'store.orderStatus.cancelled': '已取消',
  'store.orderStatus.fulfilled': '已完成',
  'store.orderStatus.pending': '待處理',
  'store.orderStatus.refunded': '已退款',
  'store.orders.colDate': '下單時間',
  'store.orders.colId': '訂單',
  'store.orders.colStatus': '狀態',
  'store.orders.colTotal': '總計',
  'store.orders.empty': '您尚未有任何訂單。',
  'store.orders.signInRequiredBody': '請先到首頁登入後查看訂單記錄。',
  'store.orders.signInRequiredTitle': '需要登入',
  'store.orders.title': '我的訂單',
  'store.product.addFailed': '無法加入購物車。',
  'store.product.addedToCart': '已加入購物車。',
  'store.product.categoryLabel': '分類',
  'store.product.currencyLabel': '付款方式',
  'store.product.notFound': '找不到該商品。',
  'store.product.priceLabel': '價格',
  'store.products.title': '商品',
  'store.products.categoryNotFound': '找不到該分類。',
  'store.products.empty': '沒有符合條件的商品。',
  'store.products.searchPlaceholder': '搜尋商品',
  'store.products.sortNewest': '最新',
  'store.products.sortUpdated': '最近更新',
  'store.cart.currencyMismatchError':
    '此商品的計價幣別與購物車中已有商品不同，請先清空購物車再切換幣別。',
  'store.checkout.paymentNote':
    '目前尚未串接金流：訂單將以待處理狀態建立，我們的團隊會人工確認付款並處理訂單。',
  'store.packageConfirmation.pendingTimeoutBody':
    '您的付款仍在確認中。您的克勞迪幣餘額將很快更新，請稍後再查看。',
  'apiError.shop.not_found': '找不到。',
  'apiError.shop.character_not_found': '未找到角色。',
  'apiError.shop.out_of_stock': '缺貨。',
  'apiError.shop.invalid_status_transition': '狀態變更無效。',
  'apiError.shop.insufficient_claudium': '您的克勞迪幣不足，無法完成此次購買。',
  'apiError.shop.not_deliverable': '此物品無法自動發放。',
  'apiError.shop.invalid_input': '輸入無效。',
  'apiError.shop.package_disabled': '該克勞迪幣禮包目前無法購買。',
  'apiError.shop.package_not_found': '找不到該克勞迪幣禮包。',
