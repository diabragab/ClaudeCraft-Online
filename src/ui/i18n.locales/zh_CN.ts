...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.packagesTab': '礼包',
  ...
  'hudChrome.wocStore.generalBody': '这里的所有商品均以克劳迪币计价，购买后立即发放。',
  'hudChrome.wocStore.searchPlaceholder': '搜索商店',
  'hudChrome.wocStore.categoryFilterLabel': '按分类筛选',
  'hudChrome.wocStore.categoryFilterAll': '全部分类',
  'hudChrome.wocStore.uncategorized': '未分类',
  'hudChrome.wocStore.noResults': '没有符合搜索条件的商品。',
  'hudChrome.wocStore.packagesBody': '可使用真实货币购买的克劳迪币礼包。',
  'hudChrome.wocStore.packagesEmpty': '目前没有可用的克劳迪币礼包。',
  'hudChrome.wocStore.packageBonus': '+{bonus} 赠送',
  'hudChrome.wocStore.packageDiscount': '{percent}% 折扣',
  'hudChrome.wocStore.packageFeatured': '精选',
  'hudChrome.wocStore.packageBuy': '以 {price} {currency} 购买',
  ...
  'hudChrome.wocStore.purchaseResult.successTitle': '购买成功！',
  'hudChrome.wocStore.purchaseResult.successBody': '{item} 已添加到您的账户。',
  'hudChrome.wocStore.purchaseResult.failureTitle': '购买失败',
  'hudChrome.wocStore.purchaseResult.failureBody': '完成 {item} 的购买时出现问题，请重试。',
  'hudChrome.wocStore.purchaseResult.dismiss': '关闭',
  ...
  'store.availability.inStock': '有货',
  'store.availability.lowStock': '库存紧张',
  'store.availability.outOfStock': '缺货',
  'store.availability.unavailable': '不可用',
  'store.availability.unlimited': '有货',
  'store.cart.checkout': '前往结算',
  'store.cart.colPrice': '价格',
  'store.cart.colProduct': '商品',
  'store.cart.colQuantity': '数量',
  'store.cart.colSubtotal': '小计',
  'store.cart.empty': '购物车是空的。',
  'store.cart.subtotalLabel': '小计',
  'store.cart.title': '我的购物车',
  'store.categories.empty': '暂无分类。',
  'store.categories.title': '分类',
  'store.checkout.emptyCart': '购物车是空的，请先添加商品再结算。',
  'store.checkout.noteLabel': '订单备注（可选）',
  'store.checkout.notePlaceholder': '有什么需要告知团队的事项吗',
  'store.checkout.orderFailed': '下单失败。',
  'store.checkout.outOfStockError': '购物车中有商品库存不足。',
  'store.checkout.placeOrder': '提交订单',
  'store.checkout.placingOrder': '正在提交订单……',
  'store.checkout.reviewTitle': '订单确认',
  'store.checkout.signInLink': '前往登录',
  'store.checkout.signInRequiredBody': '请前往主页登录后再下单。',
  'store.checkout.signInRequiredTitle': '需要登录',
  'store.checkout.title': '结算',
  'store.checkout.totalLabel': '总计',
  'store.common.addToCart': '加入购物车',
  'store.common.continueShopping': '继续购物',
  'store.common.error': '出错了，请重试。',
  'store.common.loading': '加载中……',
  'store.common.quantityLabel': '数量',
  'store.common.remove': '移除',
  'store.common.retry': '重试',
  'store.common.viewDetails': '查看详情',
  'store.confirmation.body': '您的订单 #{id} 已提交，正在等待处理。',
  'store.confirmation.title': '订单已提交',
  'store.confirmation.viewOrder': '查看订单',
  'store.home.browseAll': '浏览全部商品',
  'store.home.carouselLabel': '精选商品轮播',
  'store.home.carouselPrev': '上一个精选商品',
  'store.home.carouselNext': '下一个精选商品',
  'store.home.categoriesTitle': '按分类选购',
  'store.home.featuredTitle': '精选商品',
  'store.home.heroSubtitle': '浏览分类、精选商品和新品上架。',
  'store.home.heroTitle': '欢迎光临商店',
  'store.home.newTitle': '新品上架',
  'store.home.noFeatured': '暂无精选商品。',
  'store.home.noNew': '暂无新品。',
  'store.nav.categories': '分类',
  'store.nav.orders': '我的订单',
  'store.nav.packages': '克劳迪币礼包',
  'store.nav.products': '商品',
  'store.nav.signedInAs': '已登录：{name}',
  'store.notFound.backHome': '返回商店首页',
  'store.packages.title': '克劳迪币礼包',
  'store.packages.subtitle': '使用信用卡或借记卡购买克劳迪币，由 Stripe 安全处理。',
  'store.packages.empty': '目前没有可购买的克劳迪币礼包。',
  'store.packages.claudiumAmount': '{amount} 克劳迪币',
  'store.packages.bonusLabel': '额外赠送 {amount} 克劳迪币',
  'store.packages.featuredBadge': '精选',
  'store.packages.discountBadge': '立减 {percent}%',
  'store.packages.buy': '立即购买',
  'store.packages.starting': '正在开始结账...',
  'store.packages.checkoutFailed': '无法开始结账，请重试。',
  'store.packages.signInRequiredBody': '请在 World of ClaudeCraft 主页登录以购买克劳迪币。',
  'store.packageConfirmation.paidTitle': '感谢您的购买',
  'store.packageConfirmation.paidBody': '来自{package}的 {amount} 克劳迪币已添加到您的账户。',
  'store.packageConfirmation.pendingTitle': '正在确认您的付款',
  'store.packageConfirmation.pendingBody': '这只需要片刻，请保持此页面打开。',
  'store.packageConfirmation.failedTitle': '付款未完成',
  'store.packageConfirmation.failedBody': '此次购买未完成，因此未扣款也未发放克劳迪币。',
  'store.packageConfirmation.missingSession': '此确认链接缺少结账会话信息。',
  'store.rarity.common': '普通',
  'store.rarity.uncommon': '优秀',
  'store.rarity.rare': '精良',
  'store.rarity.epic': '史诗',
  'store.rarity.legendary': '传说',
  'store.rarity.mythic': '神话',
  'store.badge.new': '新品',
  'store.badge.hot': '热门',
  'store.badge.featured': '精选',
  'store.badge.bestValue': '超值',
  'store.badge.limited': '限量',
  'store.badge.sale': '特惠',
  'store.badge.event': '活动',
  'store.badge.exclusive': '限定',
  'store.badge.popular': '人气',
  'store.notFound.body': '该商店页面不存在。',
  'store.notFound.title': '页面未找到',
  'store.orderDetail.colLineTotal': '小计',
  'store.orderDetail.colProduct': '商品',
  'store.orderDetail.colQuantity': '数量',
  'store.orderDetail.colUnitPrice': '单价',
  'store.orderDetail.itemsTitle': '商品明细',
  'store.orderDetail.notFound': '未找到该订单。',
  'store.orderDetail.placedLabel': '下单时间',
  'store.orderDetail.statusLabel': '状态',
  'store.orderDetail.summaryTitle': '订单概要',
  'store.orderDetail.timelineCreated': '订单已创建，状态为{status}',
  'store.orderDetail.timelineTitle': '状态历史',
  'store.orderDetail.title': '订单 #{id}',
  'store.orderDetail.updatedLabel': '更新时间',
  'store.orderStatus.cancelled': '已取消',
  'store.orderStatus.fulfilled': '已完成',
  'store.orderStatus.pending': '待处理',
  'store.orderStatus.refunded': '已退款',
  'store.orders.colDate': '下单时间',
  'store.orders.colId': '订单',
  'store.orders.colStatus': '状态',
  'store.orders.colTotal': '总计',
  'store.orders.empty': '您还没有任何订单。',
  'store.orders.signInRequiredBody': '请前往主页登录后查看订单历史。',
  'store.orders.signInRequiredTitle': '需要登录',
  'store.orders.title': '我的订单',
  'store.product.addFailed': '无法加入购物车。',
  'store.product.addedToCart': '已加入购物车。',
  'store.product.categoryLabel': '分类',
  'store.product.currencyLabel': '支付方式',
  'store.product.notFound': '未找到该商品。',
  'store.product.priceLabel': '价格',
  'store.products.title': '商品',
  'store.products.categoryNotFound': '未找到该分类。',
  'store.products.empty': '没有符合条件的商品。',
  'store.products.searchPlaceholder': '搜索商品',
  'store.products.sortNewest': '最新',
  'store.products.sortUpdated': '最近更新',
  'store.cart.currencyMismatchError':
    '该商品的计价货币与购物车中已有商品不同，请先清空购物车再切换货币。',
  'store.checkout.paymentNote':
    '目前尚未接入支付渠道：订单将以待处理状态创建，我们的团队会人工确认付款并处理订单。',
  'store.packageConfirmation.pendingTimeoutBody':
    '您的付款仍在确认中。您的克劳迪币余额将很快更新，请稍后再查看。',
  'apiError.shop.not_found': '未找到。',
  'apiError.shop.character_not_found': '未找到角色。',
  'apiError.shop.out_of_stock': '缺货。',
  'apiError.shop.invalid_status_transition': '状态变更无效。',
  'apiError.shop.insufficient_claudium': '您的克劳迪币不足，无法完成此次购买。',
  'apiError.shop.not_deliverable': '此物品无法自动发放。',
  'apiError.shop.invalid_input': '输入无效。',
  'apiError.shop.package_disabled': '该克劳迪币礼包目前无法购买。',
  'apiError.shop.package_not_found': '未找到该克劳迪币礼包。',
  'apiError.shop.purchase_not_found': '未找到该笔购买记录。',
  'apiError.shop.stripe_unavailable': '银行卡购买功能目前不可用，请稍后重试。',
  'apiError.shop.invalid_webhook_signature': '无法验证此请求。',
};
