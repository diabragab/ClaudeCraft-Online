...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'apiError.shop.price_changed': '가격이 변경되었습니다. 다시 시도해 주세요.',
  'apiError.shop.claudium_unavailable': '현재 클라우디움 구매를 이용할 수 없습니다.',
  ...
  'store.packages.subtitle':
    '신용카드 또는 체크카드로 클라우디움을 구매하세요. 결제는 Stripe가 안전하게 처리합니다.',
  ...
  'store.packages.signInRequiredBody':
    '클라우디움을 구매하려면 World of ClaudeCraft 홈페이지에서 로그인해 주세요.',
  'store.packageConfirmation.paidTitle': '구매해 주셔서 감사합니다',
  'store.packageConfirmation.paidBody':
    '{package}의 클라우디움 {amount}이(가) 계정에 추가되었습니다.',
  ...
  'store.packageConfirmation.failedBody':
    '이 구매는 완료되지 않았으므로 결제나 클라우디움 지급이 이루어지지 않았습니다.',
