...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "generalBody": "Все товары здесь оцениваются в Клаудиуме и доставляются сразу после покупки.",
      "searchPlaceholder": "Поиск по магазину",
      "categoryFilterLabel": "Фильтр по категории",
      "categoryFilterAll": "Все категории",
      "uncategorized": "Без категории",
      "noResults": "Нет товаров, соответствующих поиску.",
      "packagesBody": "Наборы Клаудиума скоро будут доступны для покупки.",
      "packagesEmpty": "Сейчас нет доступных наборов Клаудиума.",
      "packageBonus": "+{bonus} бонус",
      "packageDiscount": "Скидка {percent}%",
      "packageFeatured": "Рекомендуем",
      "packageBuy": "Купить за {price} {currency}",
      "wallet": {
  ...
  "apiError": {
    ...
    "shop": {
      ...
      "invalid_status_transition": "Недопустимое изменение статуса.",
      "insufficient_claudium": "Недостаточно Клаудиума для этой покупки.",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "throttleHeading": "Ограничение действий",
        "throttleBody": "Создание, распыление, наложение чар и утилизация делят одно ограничение: не более {actions} действий за {seconds} секунд.",
  ...
  "store": {
    ...
    "home": {
      "heroTitle": "Добро пожаловать в магазин",
      "heroSubtitle": "Просматривайте категории, рекомендуемые товары и новинки.",
    ...
    "products": {
      ...
      "empty": "Нет товаров, соответствующих запросу.",
      "categoryNotFound": "Эта категория не найдена."
    },
    "product": {
      "notFound": "Этот товар не найден.",
      "priceLabel": "Цена",
      "currencyLabel": "Способ оплаты",
      "skuLabel": "SKU",
    ...
    "cart": {
      ...
      "currencyMismatchError": "Этот товар оценён в другой валюте, чем товары уже в корзине. Сначала очистите корзину, чтобы сменить валюту."
    },
    "checkout": {
      "title": "Оформление заказа",
      "reviewTitle": "Проверка заказа",
      "noteLabel": "Комментарий к заказу (необязательно)",
      "notePlaceholder": "Если хотите что-то сообщить нашей команде",
      "totalLabel": "Итого",
      "placeOrder": "Оформить заказ",
      "placingOrder": "Оформляем заказ...",
      "paymentNote": "Платёжный шлюз пока не подключён: заказ будет создан со статусом ожидания, и наша команда вручную подтвердит оплату и обработает его.",
      "emptyCart": "Ваша корзина пуста. Добавьте товар перед оформлением заказа.",
      "orderFailed": "Не удалось оформить заказ.",
      "outOfStockError": "Некоторых товаров в корзине не хватает на складе.",
      "signInRequiredTitle": "Требуется вход",
      "signInRequiredBody": "Войдите на главной странице сайта, чтобы оформить заказ.",
      "signInLink": "Перейти к входу"
    },
    "confirmation": {
      "title": "Заказ оформлен",
      "body": "Ваш заказ #{id} оформлен и ожидает обработки.",
    ...
    "orders": {
      ...
      "signInRequiredTitle": "Требуется вход",
      "signInRequiredBody": "Войдите на главной странице сайта, чтобы увидеть историю заказов.",
      "colId": "Заказ",
      "colStatus": "Статус",
      "colTotal": "Итого",
      "colDate": "Оформлен"
    ...
    "orderDetail": {
      ...
      "noteLabel": "Note",
      "timelineCreated": "Заказ создан со статусом «{status}»",
    ...
    "notFound": {
      ...
      "body": "Такой страницы магазина не существует.",
      "backHome": "Вернуться на главную магазина"
    },
    "packages": {
      "title": "Наборы Клаудиума",
      "subtitle": "Покупайте Клаудиум с помощью кредитной или дебетовой карты, безопасная обработка через Stripe.",
      "empty": "Сейчас нет доступных наборов Клаудиума.",
      "claudiumAmount": "{amount} Клаудиума",
      "bonusLabel": "+{amount} бонусного Клаудиума",
      "featuredBadge": "Рекомендуем",
      "discountBadge": "Скидка {percent}%",
      "buy": "Купить сейчас",
      "starting": "Запуск оформления заказа...",
      "checkoutFailed": "Не удалось начать оформление заказа. Попробуйте еще раз.",
      "signInRequiredBody": "Войдите на главной странице World of ClaudeCraft, чтобы купить Клаудиум."
    },
    "packageConfirmation": {
      "paidTitle": "Спасибо за покупку",
      "paidBody": "{amount} Клаудиума из набора {package} добавлено на ваш аккаунт.",
      "pendingTitle": "Подтверждаем вашу оплату",
      "pendingBody": "Это займет всего мгновение. Пожалуйста, не закрывайте эту страницу.",
      "pendingTimeoutBody": "Ваш платеж все еще подтверждается. Баланс Клаудиума обновится в ближайшее время, проверьте через несколько минут.",
      "failedTitle": "Оплата не завершена",
      "failedBody": "Эта покупка не была завершена, поэтому оплата не списана и Клаудиум не начислен.",
      "missingSession": "В этой ссылке подтверждения отсутствует информация о сессии оформления заказа."
    }
  },
  "skinEvent": {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_prof_amends_outfitter": {
        ...
        "text": "Всё же снова у моего станка. Я не держу обиды, {playerName}, но нить помнит руку, что её отпустила, и цена, чтобы взяться за неё вновь, отмеряется длиннее всякий раз. Истреби пауков-скрытней Сейблвеба, что заполонили западный лес, и этот труд успокоит твои руки, прежде чем они снова коснутся доброго шёлка.",
      ...
      "q_prof_amends_apothecary": {
        ...
        "text": "Ну, гляди-ка, кто вернулся к моему котлу. Без обид, {playerName}, на кухне всегда найдётся место, но ты знаешь, что счёт растёт всякий раз, как ты уходишь. Ступай проредить диких кабанов на восточном лугу, ведь честный пот, это первый ингредиент, и он напомнит твоим рукам о работе.",
