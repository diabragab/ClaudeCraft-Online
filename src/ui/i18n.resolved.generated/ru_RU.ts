...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "packagesBody": "Наборы Клаудиума можно приобрести за реальные деньги.",
  ...
  "store": {
    ...
    "orders": {
      ...
      "signInRequiredTitle": "Требуется вход",
      "signInRequiredBody": "Войдите на главной странице сайта, чтобы посмотреть историю заказов.",
      "colId": "Заказ",
      "colStatus": "Статус",
      "colTotal": "Итого",
      "colDate": "Оформлен"
    ...
    "packages": {
      ...
      "subtitle": "Купите Клаудиум с помощью кредитной или дебетовой карты, платёж безопасно обрабатывается Stripe.",
      ...
      "signInRequiredBody": "Войдите на главной странице сайта, чтобы купить Клаудиум."
    },
    "packageConfirmation": {
      ...
      "failedBody": "Эта покупка не была завершена, поэтому средства не были списаны, а Клаудиум не был начислен.",
      "missingSession": "В этой ссылке подтверждения отсутствует сессия оформления заказа."
    },
    "rarity": {
      "common": "Обычный",
      "uncommon": "Необычный",
