...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "generalBody": "這裡的所有商品均以克勞迪幣計價，購買後立即發放。",
      "searchPlaceholder": "搜尋商店",
      "categoryFilterLabel": "依分類篩選",
      "categoryFilterAll": "所有分類",
      "uncategorized": "未分類",
      "noResults": "沒有符合搜尋條件的商品。",
      "packagesBody": "可使用真實貨幣購買的克勞迪幣禮包。",
  ...
  "apiError": {
    ...
    "shop": {
      ...
      "out_of_stock": "缺貨。",
      "invalid_status_transition": "狀態變更無效。",
      "insufficient_claudium": "您的克勞迪幣不足，無法完成此次購買。",
      "not_deliverable": "此物品無法自動發放。",
      "invalid_input": "輸入無效。",
      "package_disabled": "該克勞迪幣禮包目前無法購買。",
      "package_not_found": "找不到該克勞迪幣禮包。",
      "purchase_not_found": "找不到該筆購買記錄。",
      "stripe_unavailable": "信用卡購買功能目前無法使用，請稍後再試。",
      "invalid_webhook_signature": "無法驗證此請求。"
    }
  },
  "guide": {
  ...
  "store": {
    ...
    "cart": {
      ...
      "subtotalLabel": "小計",
      "checkout": "前往結帳",
      "currencyMismatchError": "此商品的計價幣別與購物車中已有商品不同，請先清空購物車再切換幣別。"
    },
    "checkout": {
      "title": "結帳",
      "reviewTitle": "訂單確認",
      "noteLabel": "訂單備註（選填）",
      "notePlaceholder": "有什麼需要讓團隊知道的事項嗎",
      "totalLabel": "總計",
      "placeOrder": "送出訂單",
      "placingOrder": "正在送出訂單……",
      "paymentNote": "目前尚未串接金流：訂單將以待處理狀態建立，我們的團隊會人工確認付款並處理訂單。",
      "emptyCart": "購物車是空的，請先加入商品再結帳。",
      "orderFailed": "下單失敗。",
      "outOfStockError": "購物車中有商品庫存不足。",
      "signInRequiredTitle": "需要登入",
      "signInRequiredBody": "請先到首頁登入後再下單。",
      "signInLink": "前往登入"
    },
    "confirmation": {
      "title": "訂單已送出",
      "body": "您的訂單 #{id} 已送出，正在等待處理。",
      "viewOrder": "查看訂單"
    },
    "orders": {
      "title": "我的訂單",
      "empty": "您尚未有任何訂單。",
      "signInRequiredTitle": "需要登入",
      "signInRequiredBody": "請先到首頁登入後查看訂單記錄。",
      "colId": "訂單",
      "colStatus": "狀態",
      "colTotal": "總計",
      "colDate": "下單時間"
    ...
    "orderDetail": {
      ...
      "updatedLabel": "更新時間",
      "noteLabel": "Note",
      "timelineCreated": "訂單已建立，狀態為{status}",
    ...
    "packages": {
      "title": "克勞迪幣禮包",
      "subtitle": "使用信用卡或簽帳金融卡購買克勞迪幣，由 Stripe 安全處理。",
      "empty": "目前沒有可購買的克勞迪幣禮包。",
      "claudiumAmount": "{amount} 克勞迪幣",
      "bonusLabel": "額外贈送 {amount} 克勞迪幣",
      "featuredBadge": "精選",
      "discountBadge": "折扣 {percent}%",
      "buy": "立即購買",
      "starting": "正在開始結帳...",
      "checkoutFailed": "無法開始結帳，請重試。",
      "signInRequiredBody": "請在 World of ClaudeCraft 首頁登入以購買克勞迪幣。"
    },
    "packageConfirmation": {
      "paidTitle": "感謝您的購買",
      "paidBody": "來自{package}的 {amount} 克勞迪幣已加入您的帳戶。",
      "pendingTitle": "正在確認您的付款",
      "pendingBody": "這只需要片刻，請保持此頁面開啟。",
      "pendingTimeoutBody": "您的付款仍在確認中。您的克勞迪幣餘額將很快更新，請稍後再查看。",
      "failedTitle": "付款未完成",
