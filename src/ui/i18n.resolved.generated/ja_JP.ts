...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "generalBody": "ここにある商品はすべてクラウディウムで価格が設定されており、購入後すぐに届きます。",
      "searchPlaceholder": "ショップを検索",
      "categoryFilterLabel": "カテゴリで絞り込む",
      "categoryFilterAll": "すべてのカテゴリ",
      "uncategorized": "未分類",
      "noResults": "検索条件に一致する商品はありません。",
      "packagesBody": "クラウディウムのパッケージをリアルマネーで購入できます。",
  ...
  "apiError": {
    ...
    "shop": {
      ...
      "out_of_stock": "在庫切れです。",
      "invalid_status_transition": "無効なステータス変更です。",
      "insufficient_claudium": "クラウディウムが不足しているため購入できません。",
  ...
  "guide": {
    ...
    "profPages": {
      ...
      "econ": {
        ...
        "marketBody": "世界市場はレルム全体の取引所で、EastbrookのMerchantとHighwatchのAuctioneer Vossが取り仕切ります。出品は無料。保証金はなく、売れ残りはそのまま戻ります。手数料は成立時のみ、売値の5%です。重要な制限として、市場が扱うのは無印の品だけです。署名入り、傑作、エンチャント済み、バインド済みの品は出品されないため、特別な品は取引ウィンドウで直接手渡しされます。値付けは自分で。市場が教えてくれるのは無印の相場だけです。",
        ...
        "throttleHeading": "行動の制限",
        "throttleBody": "製作・分解・エンチャント・サルベージはひとつの制限を共有します。{seconds}秒あたり最大{actions}回です。",
  ...
  "store": {
    ...
    "home": {
      "heroTitle": "ストアへようこそ",
      "heroSubtitle": "カテゴリー、注目の商品、新着商品をご覧いただけます。",
      "featuredTitle": "注目の商品",
      "newTitle": "新着商品",
    ...
    "products": {
      ...
      "categoryNotFound": "そのカテゴリーは見つかりませんでした。"
    },
    "product": {
      "notFound": "その商品は見つかりませんでした。",
      "priceLabel": "価格",
      "currencyLabel": "支払い方法",
      "skuLabel": "SKU",
      "categoryLabel": "カテゴリー",
    ...
    "cart": {
      ...
      "subtotalLabel": "小計",
      "checkout": "レジに進む",
      "currencyMismatchError": "この商品はカート内の商品と通貨が異なります。通貨を変更するには先にカートを空にしてください。"
    },
    "checkout": {
      "title": "レジ",
      "reviewTitle": "注文内容の確認",
      "noteLabel": "注文へのメモ（任意）",
      "notePlaceholder": "運営チームに伝えたいことがあれば",
      "totalLabel": "合計",
      "placeOrder": "注文を確定する",
      "placingOrder": "注文を確定しています…",
      "paymentNote": "まだ決済手段が導入されていません。注文は保留状態で作成され、運営チームが支払いを確認したうえで手動で処理します。",
      "emptyCart": "カートが空です。注文する前に商品を追加してください。",
      "orderFailed": "注文を確定できませんでした。",
      "outOfStockError": "カート内に在庫不足の商品があります。",
      "signInRequiredTitle": "サインインが必要です",
      "signInRequiredBody": "注文するにはホームページでサインインしてください。",
      "signInLink": "サインインする"
    },
    "confirmation": {
      "title": "注文が完了しました",
      "body": "注文 #{id} を受け付けました。確認をお待ちください。",
      "viewOrder": "注文を見る"
    },
    "orders": {
      "title": "注文履歴",
      "empty": "まだ注文はありません。",
      "signInRequiredTitle": "サインインが必要です",
      "signInRequiredBody": "注文履歴を見るにはホームページでサインインしてください。",
      "colId": "注文番号",
      "colStatus": "ステータス",
      "colTotal": "合計",
      "colDate": "注文日時"
    ...
    "orderDetail": {
      "title": "注文 #{id}",
      "notFound": "その注文は見つかりませんでした。",
      "summaryTitle": "注文概要",
      "itemsTitle": "注文商品",
      "timelineTitle": "ステータス履歴",
      "colProduct": "商品",
      "colUnitPrice": "単価",
      "colQuantity": "数量",
      "colLineTotal": "小計",
      ...
      "updatedLabel": "更新日時",
      "noteLabel": "Note",
      "timelineCreated": "注文が作成されました（{status}）",
    ...
    "packages": {
      "title": "クラウディウムパッケージ",
      "subtitle": "クレジットカードまたはデビットカードでクラウディウムを購入できます。決済は Stripe が安全に処理します。",
      ...
      "signInRequiredBody": "クラウディウムを購入するにはホームページでサインインしてください。"
    },
    "packageConfirmation": {
      "paidTitle": "ご購入ありがとうございます",
      "paidBody": "{package}から{amount} クラウディウムがアカウントに追加されました。",
      "pendingTitle": "お支払いを確認しています",
      "pendingBody": "少々お待ちください。このページを閉じないでください。",
