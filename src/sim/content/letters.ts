...
// In-game Shop (Phase 5): the item-delivery leg of a Claudium purchase whose
// product carries grantKind='item'. The buyer's live character always gets
// the parcel instantly (delaySeconds: 0): the purchase already required an
// active session, so there is never an offline case to soften the delay for.
